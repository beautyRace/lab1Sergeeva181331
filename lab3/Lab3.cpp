...
int main()
{
	...
	std::cout << "bool pointer size = " << sizeof(bool *) << std::endl; // end 1 



	char arr[26] = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', // start 2 
	...
	std::cout << "viktor = " << arr1[0] << arr1[1] << arr1[2] << arr1[3] << arr1[4] << arr1[5] << std::endl; // end 2 


	int arr2[5] = { 6, 3, 5, 2, 4 }; // start 3 
	...
	std::cout << ' ' << std::endl; // end 3 


	int arr3[10] = { 5, 10, 3, 6, 7, 1, 4, 2, 9, 8 }; // start 4
